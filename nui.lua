...
local snd_airmanu = {}
local biep = false
local koranje = 118 	-- NUMPAD 9 	(Orange lights)
local kblauw = 117 	-- NUMPAD 7 	(Blue lights)
local kgroen = 97 	-- NUMPAD + 	(Green lights)
local ksirene = 111 	-- NUMPAD 8 	(Siren)
local kwerk = 96 	-- NUMPAD - 	(White work lights)
local kstop = 110 	-- NUMPAD 5 	(Stop sign in the front)
local kstop2 = 109 	-- NUMPAD 6 	(Stop sign in the back)
local kvolg = 108 	-- NUMPAD 4 	(Follow sign in the back)
local kpitje = 208 	-- PAGE UP 	(Enable/ disable pit)
local tmprst = false
